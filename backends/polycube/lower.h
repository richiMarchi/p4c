...
#ifndef _BACKENDS_POLYCUBE_LOWER_H_
#define _BACKENDS_POLYCUBE_LOWER_H_
...
/**
  This pass rewrites expressions which are not supported natively on POLYCUBE.
*/
...
#endif  /* _BACKENDS_POLYCUBE_LOWER_H_ */
