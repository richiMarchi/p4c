...
#ifndef _BACKENDS_POLYCUBE_POLYCUBEMODEL_H_
#define _BACKENDS_POLYCUBE_POLYCUBEMODEL_H_
...
struct Filter_Model : public ::Model::Elem {
    Filter_Model() : Elem("polycube_filter"),
                     parser("prs"), filter("filt") {}
    ::Model::Elem parser;
    ::Model::Elem filter;
};

// Keep this in sync with polycube_model.p4
class PolycubeModel : public ::Model::Model {
 protected:
    PolycubeModel() : Model("0.1"),
                  counterArray(),
...
#endif /* _BACKENDS_POLYCUBE_POLYCUBEMODEL_H_ */
