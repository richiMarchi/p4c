...
The back-end accepts only P4_16 code written for the `polycube_model.p4`
...
Identifiers starting with polycube_ are reserved in P4 programs, including
...
identifiers whose name starts with `polycube_`.
...
`p4c-polycube PROGRAM.p4 -o out.c`
...
specific to the generated target.
